...
public class BlockPosterVertical3 extends Block {
	...
	public void registerIcons(IconRegister iconRegister) {
		poster1 = iconRegister.registerIcon("FlenixCities:" + (this.getUnlocalizedName().substring(5)) + 1);
		poster2 = iconRegister.registerIcon("FlenixCities:" + (this.getUnlocalizedName().substring(5)) + 2);
		poster3 = iconRegister.registerIcon("FlenixCities:" + (this.getUnlocalizedName().substring(5)) + 3);
		poster4 = iconRegister.registerIcon("FlenixCities:" + (this.getUnlocalizedName().substring(5)) + 4);
	}
