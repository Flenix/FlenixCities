...
{
    private ItemStack[] fridgeLargeContents = new ItemStack[14];
    ...
    public void openChest()
    {
        ...
        this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, FlenixCities.largeFridgeBlock.blockID, 1, this.numUsingPlayers);
    }
