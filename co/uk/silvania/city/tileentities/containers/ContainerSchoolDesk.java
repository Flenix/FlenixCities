...
public class ContainerSchoolDesk extends Container {

	protected TileEntitySchoolDesk tileEntity;
	private IInventory SchoolDeskInventory;

	public ContainerSchoolDesk (InventoryPlayer inventoryPlayer, TileEntitySchoolDesk te) {
		tileEntity = te;
		//Main Storage
		for (int i = 0; i < 1; i++) {
			for (int j = 0; j < 2; j++) {
    ...
    public IInventory getSchoolDeskInventory()
    {
        return this.SchoolDeskInventory;
    }
}