...
import co.uk.silvania.city.tileentities.TileEntityFloatingShelves;

public class GuiFloatingShelves extends GuiContainer {
	
    private static final ResourceLocation texture = new ResourceLocation("flenixcities", "/textures/gui/floatingshelvesgui.png");
