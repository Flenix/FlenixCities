...
import co.uk.silvania.city.client.models.LaptopModel;
...
public class TileEntityLaptopRenderer extends TileEntitySpecialRenderer {
	...
	private final LaptopModel model;
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
		...
		Minecraft.getMinecraft().renderEngine.func_110577_a(new ResourceLocation("flenixcities", "textures/entities/laptop.png"));
		GL11.glPushMatrix();
