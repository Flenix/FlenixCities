...
import co.uk.silvania.city.tileentities.TileEntityMonitorStandingLarge;


public class MonitorStandingLargeBlock extends BlockContainer {
	

	public MonitorStandingLargeBlock(int id) {
	...
	public TileEntity createNewTileEntity(World world) {
		return new TileEntityMonitorStandingLarge();
	}
