...
import co.uk.silvania.city.tileentities.TileEntityMonitorWallLarge;


public class MonitorWallLarge extends BlockContainer {
	

	public MonitorWallLarge(int id) {
	...
	public TileEntity createNewTileEntity(World world) {
		return new TileEntityMonitorWallLarge();
	}
